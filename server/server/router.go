...
func (r *Route) Parameter(name, kind string) *Route {
	...
	if !util.InList(kind, defs.Any, util.DurationParameterType, util.StringOrFlagParameterType, util.FlagParameterType, util.BoolParameterType, util.IntParameterType, util.StringParameterType, util.ListParameterType) {
