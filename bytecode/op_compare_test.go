...
func TestComparisons(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "array equality",
			v1:   datatypes.NewFromArray(datatypes.IntType, []interface{}{5, 2, 6}),
			v2:   datatypes.NewFromArray(datatypes.IntType, []interface{}{5, 2, 6}),
			r:    true,
			f:    equalByteCode, i: nil, err: false,
		},
		{
			...
			v1:   datatypes.NewFromArray(datatypes.IntType, []interface{}{5, 2, 6}),
			v2:   datatypes.NewFromArray(datatypes.FloatType, []interface{}{5, 2, 6}),
			r:    false,
			f:    equalByteCode, i: nil, err: false,
		},
		{
			...
			v1:   datatypes.NewFromArray(datatypes.IntType, []interface{}{5, 2, 6}),
			v2:   datatypes.NewFromArray(datatypes.IntType, []interface{}{5, 6, 2}),
			r:    false,
			f:    equalByteCode, i: nil, err: false,
		},
	}
