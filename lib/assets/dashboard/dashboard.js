...
// first, followed by hi's — using the alphabet below. BigInt is required
// because JS numbers cannot represent a full 64-bit value precisely.
...
function initCodeEditor() {
    ...
    // Map from data-mode value to the main button label.
    const modeLabelMap = { run: '\u25B6 Run', debug: '\u{1F41B} Debug', trace: '\u{1F463} Trace' };
