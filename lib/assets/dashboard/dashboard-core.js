...
// empty array means every class). These three are sent to the server as query
// parameters; the line count is kept separately in its own cookie because it is
// a lasting preference rather than part of a filter the user clears.
let logFilterState = { session: 0, msg: '', classes: [] };
...
function loadLogFilter() {
    ...
    try {
        ...
        logFilterState = { session: 0, msg: '', classes: [] };
    }
}
