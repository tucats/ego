...
const PERMISSION_TABS = ['memory', 'users', 'log', 'sql', 'code'];
...
// ego.code (or ego.root). Every tab not in PERMISSION_TABS -- DSNs, Tables,
// Data -- is available to any logged-in user.
