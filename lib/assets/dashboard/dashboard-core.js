...
// no bound on that end) that restrict results to a time range. These six are
...
let logFilterState = { session: 0, msg: '', classes: [], archive: false, since: '', until: '' };
...
function loadLogFilter() {
    ...
    try {
        ...
        logFilterState = { session: 0, msg: '', classes: [], archive: false, since: '', until: '' };
    }
}
