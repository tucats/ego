...
| DB       | Logs information about active database connections using the db package  |
| DEBUG    | Logs miscellaneous debugging information                                 |
| SERVER   | Logs information about the use of _Ego_ as a REST server.                |
| SYMBOLS  | Logs symbol table and symbol name operations                             |
| TABLES   | Logs execution of backend SQL to support /tables endpoints               |
