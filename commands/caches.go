...
func cacheAsText(cacheStatus defs.CacheResponse, showServices bool, showAssets bool, showClass bool, t *tables.Table) {
	...
	_ = mt.AddRowItems(i18n.L("cache.stat.user.items"), cacheStatus.UserItemsCount)
	_ = mt.AddRowItems(" ", " ")
	_ = mt.AddRowItems(i18n.L("cache.stat.authorizations"), cacheStatus.AuthorizationCount)
	_ = mt.AddRowItems(i18n.L("cache.stat.decrypted.tokens"), cacheStatus.TokenCount)
	_ = mt.AddRowItems(i18n.L("cache.stat.blacklist.status"), cacheStatus.BlacklistCount)
	_ = mt.AddRowItems(" ", " ")
	_ = mt.AddRowItems(i18n.L("cache.stat.dsn.authorizations"), cacheStatus.DSNCount)
	_ = mt.AddRowItems(i18n.L("cache.stat.schemas"), cacheStatus.SchemaCount)
	_ = mt.AddRowItems(" ", " ")
	_ = mt.AddRowItems(i18n.L("cache.stat.code.sessions"), cacheStatus.RunCount)
	_ = mt.AddRowItems(i18n.L("cache.stat.debug.sessions"), cacheStatus.DebugCount)
