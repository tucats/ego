...
var SortPackage = data.NewPackageFromMap("sort", map[string]any{
	...
	"Float32s": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.Float32Type), data.ErrorType},
		},
		Value: sortFloat32s,
	},
	"Float64s": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.Float64Type), data.ErrorType},
		},
		Value: sortFloat64s,
	},
	"Int32s": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.Int32Type), data.ErrorType},
		},
		Value: sortInt32s,
	},
	"Int64s": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.Int64Type), data.ErrorType},
		},
		Value: sortInt64s,
	},
	"Ints": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.IntType), data.ErrorType},
		},
		Value: sortInts,
	},
	"Slice": data.Function{
		Declaration: &data.Declaration{
			...
			Returns: []*data.Type{data.ArrayType(data.InterfaceType), data.ErrorType},
		},
		Value: sortSlice,
	},
	...
	"SearchInts": data.Function{
		...
		Value: sortSearchInts,
	},
	"SearchFloat64s": data.Function{
		Declaration: &data.Declaration{
			Name: "SearchFloat64s",
			Parameters: []data.Parameter{
				{
		...
		Value: sortSearchFloat64s,
	},
	"SearchStrings": data.Function{
		Declaration: &data.Declaration{
			Name: "SearchStrings",
			Parameters: []data.Parameter{
				{
