...
// DSNGenerateResponse is the JSON body returned by POST /dsns/{dsnname}/tables/@generate.
//
// SQL contains the query text generated by the configured AI endpoint from the
// caller's natural-language request and the DSN's table/column schema.
type DSNGenerateResponse struct {
	// Standard server identification and request metadata.
	ServerInfo `json:"server"`

	// The AI-generated SQL query text.
	SQL string `json:"sql"`
