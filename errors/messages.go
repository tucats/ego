...
var ErrCertificateParseError = errors.New(i18n.E("cert.parse.err"))
...
var ErrFunctionReturnedVoid = errors.New(i18n.E("func.void"))
...
var ErrInvalidScopeLevel = errors.New(i18n.E("scope.invalid"))
...
var ErrInvalidStructOrPackage = errors.New(i18n.E("invalid.struct.or.package"))
...
var ErrSymbolNotExported = errors.New(i18n.E("symbol.not.exported"))
...
var ErrUnrecognizedCommand = errors.New(i18n.E("cli.command.not.found"))
